...
7. The application will open in the browser at: http://127.0.0.1:5500/index.html
...
- No real-time data ingestion or enforcement integration

Future Improvements:
- Live data integration and automated updates
- Expanded scenario simulation and optimisation
